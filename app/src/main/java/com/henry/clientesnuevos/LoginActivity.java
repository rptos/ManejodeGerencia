...
import Connection.SendPostSignIn;
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(this).load(R.drawable.logo_animado).into((ImageView) mProgressView);
    ...
    private void attemptLogin(View v) {
        ...
        if (cancel) {
            ...
            showProgress(true);
            SendPostSignIn.sendPost(email, password, context, v, this);
